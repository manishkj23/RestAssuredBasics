Feature: Claim creation via DGX API for Hoover Candy OEM

  @DGXAPI
  Scenario Outline: Verify users can create a claim and book an appointment for HooverCandy plan via DGX API
    ...
    Examples:
      ...
      | VU49017194 | HOOVER | WASHING MACHINE | AH3W 410    |
